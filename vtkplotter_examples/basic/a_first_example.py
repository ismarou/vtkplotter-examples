...
(c+s).show()    # Mesh+Mesh = Assembly, then show it.
show(c,s)       # can show list of [Mesh, Volume, filename ...]
...
print("-> (c+s).show()  # Mesh+Mesh = Assembly, then show it.")
(c + s).show()

print("-> show(c,s)   # can show list of [Mesh, Volume, filename ...]")
show(c, s)
